# 04. Basic SELECT, filters and ordering

Use SELECT, FILTER, ORDER BY, LIMIT and OFFSET with stable tie-breaking. Codes remain strings and durations are integers.
