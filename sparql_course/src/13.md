# 13. Containers, collections and blank nodes

RDF containers use membership predicates; collections use first/rest lists. Traverse lists structurally and avoid durable dependence on blank-node labels.
