# 02. Environment and explicit endpoint configuration

Use the local Python/Java setup. Provision Fuseki separately if needed; the course does not silently create a dataset or grant administrator access.
