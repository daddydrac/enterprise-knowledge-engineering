# 06. RDF datatypes and literals

Use STR, DATATYPE and LANG deliberately. A string category such as >8 is not a numeric observation. Use only source-supported dates and units.
