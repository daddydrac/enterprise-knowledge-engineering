# 14. Federation and remote failures

Use HTTPS, destination allowlists, timeouts and visible failure policy. Do not send sensitive bindings to an unreviewed SERVICE endpoint.
